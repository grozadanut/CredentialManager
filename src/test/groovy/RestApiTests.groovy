...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.CredentialManagerTime
    ...
    @Unroll
    def "call CredentialManager REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test CredentialManager Rest API here
        // "put" | "s1/CredentialManager/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
